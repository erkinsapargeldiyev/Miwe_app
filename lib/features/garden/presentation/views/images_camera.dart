...
class ImagesCamera extends StatefulWidget {
  final List<Uint8List> images;
  const ImagesCamera({super.key, required this.images});

  @override
  State<ImagesCamera> createState() => _ImagesCameraState();
}

class _ImagesCameraState extends State<ImagesCamera> {
